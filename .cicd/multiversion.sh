...
[[ ! -d $GIT_ROOT/arisen_multiversion_builder ]] && mkdir $GIT_ROOT/arisen_multiversion_builder
# pipeline config
...
# multiversion
cd $GIT_ROOT/arisen_multiversion_builder
echo 'Downloading other versions of aos...'
python2.7 $GIT_ROOT/.cicd/helpers/multi_arisen_docker.py
cd $GIT_ROOT
