...
FC_REFLECT(arisenio::test_control_apis::empty, )
FC_REFLECT(arisenio::test_control_apis::read_write::kill_node_on_producer_params, (producer)(where_in_sequence)(based_on_lib) )
