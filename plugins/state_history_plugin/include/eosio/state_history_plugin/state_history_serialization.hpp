...
#include <arisenio/chain/permission_link_object.hpp>
#include <arisenio/chain/permission_object.hpp>
#include <arisenio/chain/protocol_state_object.hpp>
#include <arisenio/chain/resource_limits.hpp>
#include <arisenio/chain/resource_limits_private.hpp>
#include <arisenio/chain/trace.hpp>
#include <arisenio/chain_plugin/chain_plugin.hpp>
#include <arisenio/state_history_plugin/state_history_plugin.hpp>
...
datastream<ST>& history_serialize_container(datastream<ST>& ds, const chainbase::database& db,
   ...
   fc::raw::pack(ds, unsigned_int(v.size()));
   for (auto& x : v) {
      ARISEN_ASSERT(!!x, arisenio::chain::plugin_exception, "null inside container");
      ds << make_history_serial_wrapper(db, *x);
   }
   return ds;
}
...
template <typename ST>
void history_pack_big_bytes(datastream<ST>& ds, const arisenio::chain::bytes& v) {
...
template <typename ST>
void history_pack_big_bytes(datastream<ST>& ds, const fc::optional<arisenio::chain::bytes>& v) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::account_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   fc::raw::pack(ds, as_type<arisenio::chain::block_timestamp_type>(obj.obj.creation_date));
   fc::raw::pack(ds, as_type<arisenio::chain::shared_string>(obj.obj.abi));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                      ds,
                           const history_serial_wrapper<arisenio::chain::account_metadata_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   fc::raw::pack(ds, as_type<bool>(obj.obj.is_privileged()));
   fc::raw::pack(ds, as_type<fc::time_point>(obj.obj.last_code_update));
   bool has_code = obj.obj.code_hash != arisenio::chain::digest_type();
   fc::raw::pack(ds, has_code);
   if (has_code) {
      fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_type));
      fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_version));
      fc::raw::pack(ds, as_type<arisenio::chain::digest_type>(obj.obj.code_hash));
   }
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::code_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_type));
   fc::raw::pack(ds, as_type<uint8_t>(obj.obj.vm_version));
   fc::raw::pack(ds, as_type<arisenio::chain::digest_type>(obj.obj.code_hash));
   fc::raw::pack(ds, as_type<arisenio::chain::shared_string>(obj.obj.code));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::table_id_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
operator<<(datastream<ST>&                                                                               ds,
           const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::key_value_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<arisenio::chain::shared_string>(obj.obj.value));
   return ds;
}
...
template <typename ST>
void serialize_secondary_index_data(datastream<ST>& ds, const arisenio::chain::key256_t& obj) {
...
template <typename ST, typename T>
datastream<ST>& serialize_secondary_index(datastream<ST>& ds, const arisenio::chain::table_id_object& context,
                                          const T& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                             ds,
           const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::index64_object>& obj) {
...
datastream<ST>&
operator<<(datastream<ST>&                                                                              ds,
           const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::index128_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                              ds,
           const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::index256_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                  ds,
           const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::index_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}
...
datastream<ST>& operator<<(
    datastream<ST>&                                                                                       ds,
    const history_context_wrapper<arisenio::chain::table_id_object, arisenio::chain::index_long_double_object>& obj) {
   return serialize_secondary_index(ds, obj.context, obj.obj);
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::producer_key>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.producer_name.value));
   fc::raw::pack(ds, as_type<arisenio::chain::public_key_type>(obj.obj.block_signing_key));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                            ds,
                           const history_serial_wrapper<arisenio::chain::shared_producer_schedule_type>& obj) {
   fc::raw::pack(ds, as_type<uint32_t>(obj.obj.version));
   history_serialize_container(ds, obj.db,
                               as_type<arisenio::chain::shared_vector<arisenio::chain::producer_key>>(obj.obj.producers));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::chain_config>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<arisenio::chain::global_property_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<optional<arisenio::chain::block_num_type>>(obj.obj.proposed_schedule_block_num));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<arisenio::chain::shared_producer_schedule_type>(obj.obj.proposed_schedule)));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::chain_config>(obj.obj.configuration)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                           ds,
                           const history_serial_wrapper<arisenio::chain::generated_transaction_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.sender.value));
   fc::raw::pack(ds, as_type<__uint128_t>(obj.obj.sender_id));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.payer.value));
   fc::raw::pack(ds, as_type<arisenio::chain::transaction_id_type>(obj.obj.trx_id));
   fc::raw::pack(ds, as_type<arisenio::chain::shared_string>(obj.obj.packed_trx));
   return ds;
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                                ds,
           const history_serial_wrapper<arisenio::chain::protocol_state_object::activated_protocol_feature>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<arisenio::chain::digest_type>(obj.obj.feature_digest));
   fc::raw::pack(ds, as_type<uint32_t>(obj.obj.activation_block_num));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::protocol_state_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::key_weight>& obj) {
   fc::raw::pack(ds, as_type<arisenio::chain::public_key_type>(obj.obj.key));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::permission_level>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                      ds,
                           const history_serial_wrapper<arisenio::chain::permission_level_weight>& obj) {
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::permission_level>(obj.obj.permission)));
   fc::raw::pack(ds, as_type<uint16_t>(obj.obj.weight));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::wait_weight>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::shared_authority>& obj) {
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::permission_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   if (obj.obj.parent._id) {
      auto&       index  = obj.db.get_index<arisenio::chain::permission_index>();
      const auto* parent = index.find(obj.obj.parent);
      if (!parent) {
         auto& undo = index.stack().back();
         auto  it   = undo.removed_values.find(obj.obj.parent);
         ARISEN_ASSERT(it != undo.removed_values.end(), arisenio::chain::plugin_exception,
   ...
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::shared_authority>(obj.obj.auth)));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<arisenio::chain::permission_link_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                      ds,
                           const history_serial_wrapper<arisenio::chain::resource_limits::resource_limits_object>& obj) {
   ARISEN_ASSERT(!obj.obj.pending, arisenio::chain::plugin_exception,
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                 ds,
                           const history_serial_wrapper<arisenio::chain::resource_limits::usage_accumulator>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                     ds,
                           const history_serial_wrapper<arisenio::chain::resource_limits::resource_usage_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.owner.value));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<arisenio::chain::resource_limits::usage_accumulator>(obj.obj.net_usage)));
   fc::raw::pack(ds, make_history_serial_wrapper(
                         obj.db, as_type<arisenio::chain::resource_limits::usage_accumulator>(obj.obj.cpu_usage)));
...
datastream<ST>&
operator<<(datastream<ST>&                                                                            ds,
           const history_serial_wrapper<arisenio::chain::resource_limits::resource_limits_state_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::resource_limits::usage_accumulator>(
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                     ds,
                           const history_serial_wrapper<arisenio::chain::resource_limits::ratio>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                                        ds,
                           const history_serial_wrapper<arisenio::chain::resource_limits::elastic_limit_parameters>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   ...
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::resource_limits::ratio>(obj.obj.contract_rate)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::resource_limits::ratio>(obj.obj.expand_rate)));
   return ds;
}
...
datastream<ST>&
operator<<(datastream<ST>&                                                                             ds,
           const history_serial_wrapper<arisenio::chain::resource_limits::resource_limits_config_object>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<arisenio::chain::resource_limits::elastic_limit_parameters>(obj.obj.cpu_limit_parameters)));
   fc::raw::pack(
       ds, make_history_serial_wrapper(
               obj.db, as_type<arisenio::chain::resource_limits::elastic_limit_parameters>(obj.obj.net_limit_parameters)));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::action>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.name.value));
   history_serialize_container(ds, obj.db, as_type<std::vector<arisenio::chain::permission_level>>(obj.obj.authorization));
   fc::raw::pack(ds, as_type<arisenio::bytes>(obj.obj.data));
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::action_receipt>& obj) {
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.value));
   fc::raw::pack(ds, as_type<arisenio::chain::digest_type>(obj.obj.act_digest));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.global_sequence));
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.recv_sequence));
   history_serialize_container(ds, obj.db, as_type<flat_map<arisenio::name, uint64_t>>(obj.obj.auth_sequence));
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_serial_wrapper<arisenio::chain::account_delta>& obj) {
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.account.value));
...
inline fc::optional<uint64_t> cap_error_code( const fc::optional<uint64_t>& error_code ) {
   ...
   const uint64_t upper_limit = static_cast<uint64_t>(arisenio::chain::system_error_code::generic_system_error);
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const history_context_wrapper<bool, arisenio::chain::action_trace>& obj) {
   ...
   if (obj.obj.receipt) {
      fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::action_receipt>(*obj.obj.receipt)));
   }
   fc::raw::pack(ds, as_type<uint64_t>(obj.obj.receiver.value));
   fc::raw::pack(ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::action>(obj.obj.act)));
   ...
   history_serialize_container(ds, obj.db, as_type<flat_set<arisenio::chain::account_delta>>(obj.obj.account_ram_deltas));
...
datastream<ST>& operator<<(datastream<ST>&                                                    ds,
                           const history_context_wrapper<std::pair<uint8_t, bool>,
                                                         arisenio::augmented_transaction_trace>& obj) {
   auto& trace = *obj.obj.trace;
   bool  debug_mode = obj.context.second;
   fc::raw::pack(ds, fc::unsigned_int(0));
   fc::raw::pack(ds, as_type<arisenio::chain::transaction_id_type>(trace.id));
   if (trace.receipt) {
      if (trace.failed_dtrx_trace && trace.receipt->status.value == arisenio::chain::transaction_receipt_header::soft_fail)
         fc::raw::pack(ds, uint8_t(arisenio::chain::transaction_receipt_header::executed));
      else
   ...
   history_context_serialize_container(ds, obj.db, debug_mode,
                                       as_type<std::vector<arisenio::chain::action_trace>>(trace.action_traces));

   fc::raw::pack(ds, bool(trace.account_ram_delta));
   if (trace.account_ram_delta) {
      fc::raw::pack(
          ds, make_history_serial_wrapper(obj.db, as_type<arisenio::chain::account_delta>(*trace.account_ram_delta)));
   }
   ...
   if (trace.failed_dtrx_trace) {
      uint8_t stat = arisenio::chain::transaction_receipt_header::hard_fail;
      if (trace.receipt && trace.receipt->status.value == arisenio::chain::transaction_receipt_header::soft_fail)
         stat = arisenio::chain::transaction_receipt_header::soft_fail;
      std::pair<uint8_t, bool> context = std::make_pair(stat, debug_mode);
      fc::raw::pack( //
          ds, make_history_context_wrapper(
                  obj.db, context, arisenio::augmented_transaction_trace{trace.failed_dtrx_trace, obj.obj.partial}));
   }
   ...
   if (include_partial) {
      ...
      fc::raw::pack(ds, fc::unsigned_int(0));
      fc::raw::pack(ds, as_type<arisenio::chain::time_point_sec>(partial.expiration));
      ...
      fc::raw::pack(ds, as_type<arisenio::chain::extensions_type>(partial.transaction_extensions));
      fc::raw::pack(ds, as_type<std::vector<arisenio::chain::signature_type>>(partial.signatures));
      fc::raw::pack(ds, as_type<std::vector<arisenio::bytes>>(partial.context_free_data));
   }
...
template <typename ST>
datastream<ST>& operator<<(datastream<ST>&                                                           ds,
                           const history_context_wrapper<bool, arisenio::augmented_transaction_trace>&  obj) {
   std::pair<uint8_t, bool> context = std::make_pair(arisenio::chain::transaction_receipt_header::hard_fail, obj.context);
   ds << make_history_context_wrapper(obj.db, context, obj.obj);
   return ds;
}

template <typename ST>
datastream<ST>& operator<<(datastream<ST>& ds, const arisenio::get_blocks_result_v0& obj) {
