...
CHAINBASE_SET_INDEX_TYPE( arisenio::account_control_history_object, arisenio::account_control_history_multi_index )

FC_REFLECT( arisenio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
