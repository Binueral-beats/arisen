...
CHAINBASE_SET_INDEX_TYPE( arisenio::public_key_history_object, arisenio::public_key_history_multi_index )

FC_REFLECT( arisenio::public_key_history_object, (public_key)(name)(permission) )
