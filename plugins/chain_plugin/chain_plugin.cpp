   ...
   try {
      ...
      if (options.count( "snapshot" )) {
         ...
         if( options.count( "genesis-json" )) {
            ...
            RSN_ASSERT( fc::is_regular_file( genesis_path ),
                        plugin_config_exception,
            ...
            RSN_ASSERT( my->chain_config->genesis == genesis_file, plugin_config_exception,
         ...
         RSN_ASSERT( !fc::exists(shared_mem_path),
                 plugin_config_exception,
         ...
         if( fc::is_regular_file( my->blocks_dir / "blocks.log" )) {
            ...
            RSN_ASSERT( log_genesis.compute_chain_id() == my->chain_config->genesis.compute_chain_id(),
                    plugin_config_exception,
         ...
         if( !existing_genesis ) {
            ...
            RSN_ASSERT( my->chain_config->genesis == *existing_genesis, plugin_config_exception,
