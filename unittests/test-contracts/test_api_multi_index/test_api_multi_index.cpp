...
namespace _test_multi_index {
   ...
   struct record_idx64 {
      ...
      ARISENLIB_SERIALIZE( record_idx64, (id)(sec) )
   };
   ...
   struct record_idx128 {
      ...
      ARISENLIB_SERIALIZE( record_idx128, (id)(sec) )
   };
   ...
   struct record_idx256 {
      ...
      ARISENLIB_SERIALIZE( record_idx256, (id)(sec) )
   };
   ...
   struct record_idx_double {
      ...
      ARISENLIB_SERIALIZE( record_idx_double, (id)(sec) )
   };
   ...
   struct record_idx_long_double {
      ...
      ARISENLIB_SERIALIZE( record_idx_long_double, (id)(sec) )
   };
