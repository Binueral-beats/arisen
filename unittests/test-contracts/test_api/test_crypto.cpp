...
void test_crypto::test_sha1() {
   ...
   eosio_assert( my_memcmp((void *)test1_ok_1, &tmp, sizeof(arisen::checksum160)), "sha1 test1" );

   tmp = arisen::sha1( test3, my_strlen(test3) );
   eosio_assert( my_memcmp((void *)test3_ok_1, &tmp, sizeof(arisen::checksum160)), "sha1 test3" );

   tmp = arisen::sha1( test4, my_strlen(test4) );
   eosio_assert( my_memcmp((void *)test4_ok_1, &tmp, sizeof(arisen::checksum160)), "sha1 test4" );

   tmp = arisen::sha1( test5, my_strlen(test5) );
   eosio_assert( my_memcmp((void *)test5_ok_1, &tmp, sizeof(arisen::checksum160)), "sha1 test5" );
}
...
void test_crypto::test_sha256() {
  ...
  eosio_assert( my_memcmp((void *)test1_ok_256, &tmp, sizeof(arisen::checksum256)), "sha256 test1" );

  tmp = arisen::sha256( test3, my_strlen(test3) );
  eosio_assert( my_memcmp((void *)test3_ok_256, &tmp, sizeof(arisen::checksum256)), "sha256 test3" );

  tmp = arisen::sha256( test4, my_strlen(test4) );
  eosio_assert( my_memcmp((void *)test4_ok_256, &tmp, sizeof(arisen::checksum256)), "sha256 test4" );

  tmp = arisen::sha256( test5, my_strlen(test5) );
  eosio_assert( my_memcmp((void *)test5_ok_256, &tmp, sizeof(arisen::checksum256)), "sha256 test5" );
}
...
void test_crypto::test_sha512() {
  ...
  eosio_assert( my_memcmp((void *)test1_ok_512, &tmp, sizeof(arisen::checksum512)), "sha512 test1" );

  tmp = arisen::sha512( test3, my_strlen(test3) );
  eosio_assert( my_memcmp((void *)test3_ok_512, &tmp, sizeof(arisen::checksum512)), "sha512 test3" );

  tmp = arisen::sha512( test4, my_strlen(test4) );
  eosio_assert( my_memcmp((void *)test4_ok_512, &tmp, sizeof(arisen::checksum512)), "sha512 test4" );

  tmp = arisen::sha512( test5, my_strlen(test5) );
  eosio_assert( my_memcmp((void *)test5_ok_512, &tmp, sizeof(arisen::checksum512)), "sha512 test5" );
}
...
void test_crypto::test_ripemd160() {
  ...
  eosio_assert( my_memcmp((void *)test1_ok_ripe, &tmp, sizeof(arisen::checksum160)), "ripemd160 test1" );

  tmp = arisen::ripemd160( test3, my_strlen(test3) );
  eosio_assert( my_memcmp((void *)test3_ok_ripe, &tmp, sizeof(arisen::checksum160)), "ripemd160 test3" );

  tmp = arisen::ripemd160( test4, my_strlen(test4) );
  eosio_assert( my_memcmp((void *)test4_ok_ripe, &tmp, sizeof(arisen::checksum160)), "ripemd160 test4" );

  tmp = arisen::ripemd160( test5, my_strlen(test5) );
  eosio_assert( my_memcmp((void *)test5_ok_ripe, &tmp, sizeof(arisen::checksum160)), "ripemd160 test5" );
}
...
void test_crypto::sha1_no_data() {
  ...
  eosio_assert( my_memcmp((void *)test2_ok_1, &tmp, sizeof(arisen::checksum160)), "sha1 test2" );
}
...
void test_crypto::sha256_no_data() {
  ...
  eosio_assert( my_memcmp((void *)test2_ok_256, &tmp, sizeof(arisen::checksum256)), "sha256 test2" );
}
...
void test_crypto::sha512_no_data() {
  ...
  eosio_assert( my_memcmp((void *)test2_ok_512, &tmp, sizeof(arisen::checksum512)), "sha512 test2" );
}
...
void test_crypto::ripemd160_no_data() {
  ...
  eosio_assert( my_memcmp((void *)test2_ok_ripe, &tmp, sizeof(arisen::checksum160)), "ripemd160 test2" );
}
