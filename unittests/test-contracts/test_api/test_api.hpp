...
namespace arisenio { class transaction; }

// NOTE: including ariseniolib/transaction.hpp here causes !"unresolvable": env._ZNKSt3__120__vector_base_commonILb1EE20__throw_length_errorEv
...
struct test_transaction {
   ...
   static void assert_false_error_handler(const arisenio::transaction&);
