...
#include "arisenio_system_tester.hpp"
 ...
 * ram_tests test case
 *************************************************************************************/
BOOST_FIXTURE_TEST_CASE(ram_tests, arisenio_system::arisenio_system_tester) { try {
   ...
   produce_blocks(10);
   BOOST_REQUIRE_EQUAL( success(), stake( "arisenio.stake", "testram11111", core_from_string("10.0000"), core_from_string("5.0000") ) );
   produce_blocks(10);
