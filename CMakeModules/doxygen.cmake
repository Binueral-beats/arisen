configure_file("rsn.doxygen.in" "${CMAKE_BINARY_DIR}/rsn.doxygen")
...
if(NOT DOXYGEN_FOUND)
  ...
  set(DOXY_ARISEN_VERSION "${VERSION_FULL}" CACHE INTERNAL "Version string used in PROJECT_NUMBER.")
  ...
  if(BUILD_DOXYGEN)
    ...
    add_custom_target(contract_documentation ALL
      COMMAND "${DOXYGEN_EXECUTABLE}" "${CMAKE_BINARY_DIR}/rsn.doxygen"
