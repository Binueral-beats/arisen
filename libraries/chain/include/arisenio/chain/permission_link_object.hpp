...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::permission_link_object, arisenio::chain::permission_link_index)

FC_REFLECT(arisenio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
