...
#include <arisenio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::global_property_object, arisenio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::dynamic_global_property_object,
                         arisenio::chain::dynamic_global_property_multi_index)

FC_REFLECT(arisenio::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(arisenio::chain::dynamic_global_property_object,
