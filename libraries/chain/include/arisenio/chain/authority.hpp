...
FC_REFLECT(arisenio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(arisenio::chain::key_weight, (key)(weight) )
FC_REFLECT(arisenio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(arisenio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(arisenio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
