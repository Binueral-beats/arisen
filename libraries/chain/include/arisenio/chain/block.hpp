...
FC_REFLECT_ENUM( arisenio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(arisenio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(arisenio::chain::transaction_receipt, (arisenio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(arisenio::chain::signed_block, (arisenio::chain::signed_block_header), (transactions)(block_extensions) )
