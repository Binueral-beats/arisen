...
#include <arisenio/chain/action.hpp>
#include <numeric>
...
namespace arisenio { namespace chain {
   ...
   struct transaction : public transaction_header {
      ...
      vector<arisenio::chain::transaction_extensions> validate_and_extract_extensions()const;
   };
...
FC_REFLECT(arisenio::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
FC_REFLECT( arisenio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( arisenio::chain::transaction, (arisenio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( arisenio::chain::signed_transaction, (arisenio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( arisenio::chain::packed_transaction::compression_type, (none)(zlib))
// @ignore unpacked_trx
FC_REFLECT( arisenio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
