...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::block_summary_object, arisenio::chain::block_summary_multi_index)

FC_REFLECT( arisenio::chain::block_summary_object, (block_id) )
