...
#include <arisenio/chain/action_receipt.hpp>
...
FC_REFLECT( arisenio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( arisenio::chain::action_trace,
...
FC_REFLECT( arisenio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
