...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::transaction_object, arisenio::chain::transaction_multi_index)

FC_REFLECT(arisenio::chain::transaction_object, (expiration)(trx_id))
