...
#include <arisenio/chain/abi_def.hpp>
...
namespace arisenio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const arisenio::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      arisenio::chain::abi_def get_abi()const {
         arisenio::chain::abi_def a;
         ARISEN_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::account_object, arisenio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::account_metadata_object, arisenio::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::account_ram_correction_object, arisenio::chain::account_ram_correction_index)


FC_REFLECT(arisenio::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(arisenio::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(arisenio::chain::account_ram_correction_object, (name)(ram_correction))
