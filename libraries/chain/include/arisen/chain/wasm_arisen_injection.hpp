...
#include <arisenio/chain/wasm_arisenio_binary_ops.hpp>
#include <arisenio/chain/wasm_arisenio_constraints.hpp>
#include <arisenio/chain/webassembly/common.hpp>
...
namespace arisenio { namespace chain { namespace wasm_injections {
   using namespace IR;
   ...
   struct injector_utils {
      ...
      static void add_import(Module& module, const char* func_name, int32_t& index ) {
         if (module.functions.imports.size() == 0 || registered_injected.find(func_name) == registered_injected.end() ) {
            ...
            decltype(module.functions.imports) new_import = { {{func_type_index}, ARISENIO_INJECTED_MODULE_NAME, std::move(func_name)} };
...
#undef CLEAR
   ...
   struct call_depth_check_and_insert_checktime {
      ...
      static void accept( wasm_ops::instr* inst, wasm_ops::visitor_arg& arg ) {
         if ( global_idx == -1 ) {
            arg.module->globals.defs.push_back({{ValueType::i32, true}, {(I32) arisenio::chain::wasm_constraints::maximum_call_depth}});
         }
...
#undef INSERT_INJECTED
   ...
   constexpr const char* inject_which_op( uint16_t opcode ) {
      switch ( opcode ) {
         case wasm_ops::f32_add_code:
            return u8"_arisenio_f32_add";
         case wasm_ops::f32_sub_code:
            return u8"_arisenio_f32_sub";
         case wasm_ops::f32_mul_code:
            return u8"_arisenio_f32_mul";
         case wasm_ops::f32_div_code:
            return u8"_arisenio_f32_div";
         case wasm_ops::f32_min_code:
            return u8"_arisenio_f32_min";
         case wasm_ops::f32_max_code:
            return u8"_arisenio_f32_max";
         case wasm_ops::f32_copysign_code:
            return u8"_arisenio_f32_copysign";
         case wasm_ops::f32_abs_code:
            return u8"_arisenio_f32_abs";
         case wasm_ops::f32_neg_code:
            return u8"_arisenio_f32_neg";
         case wasm_ops::f32_sqrt_code:
            return u8"_arisenio_f32_sqrt";
         case wasm_ops::f32_ceil_code:
            return u8"_arisenio_f32_ceil";
         case wasm_ops::f32_floor_code:
            return u8"_arisenio_f32_floor";
         case wasm_ops::f32_trunc_code:
            return u8"_arisenio_f32_trunc";
         case wasm_ops::f32_nearest_code:
            return u8"_arisenio_f32_nearest";
         case wasm_ops::f32_eq_code:
            return u8"_arisenio_f32_eq";
         case wasm_ops::f32_ne_code:
            return u8"_arisenio_f32_ne";
         case wasm_ops::f32_lt_code:
            return u8"_arisenio_f32_lt";
         case wasm_ops::f32_le_code:
            return u8"_arisenio_f32_le";
         case wasm_ops::f32_gt_code:
            return u8"_arisenio_f32_gt";
         case wasm_ops::f32_ge_code:
            return u8"_arisenio_f32_ge";
         case wasm_ops::f64_add_code:
            return u8"_arisenio_f64_add";
         case wasm_ops::f64_sub_code:
            return u8"_arisenio_f64_sub";
         case wasm_ops::f64_mul_code:
            return u8"_arisenio_f64_mul";
         case wasm_ops::f64_div_code:
            return u8"_arisenio_f64_div";
         case wasm_ops::f64_min_code:
            return u8"_arisenio_f64_min";
         case wasm_ops::f64_max_code:
            return u8"_arisenio_f64_max";
         case wasm_ops::f64_copysign_code:
            return u8"_arisenio_f64_copysign";
         case wasm_ops::f64_abs_code:
            return u8"_arisenio_f64_abs";
         case wasm_ops::f64_neg_code:
            return u8"_arisenio_f64_neg";
         case wasm_ops::f64_sqrt_code:
            return u8"_arisenio_f64_sqrt";
         case wasm_ops::f64_ceil_code:
            return u8"_arisenio_f64_ceil";
         case wasm_ops::f64_floor_code:
            return u8"_arisenio_f64_floor";
         case wasm_ops::f64_trunc_code:
            return u8"_arisenio_f64_trunc";
         case wasm_ops::f64_nearest_code:
            return u8"_arisenio_f64_nearest";
         case wasm_ops::f64_eq_code:
            return u8"_arisenio_f64_eq";
         case wasm_ops::f64_ne_code:
            return u8"_arisenio_f64_ne";
         case wasm_ops::f64_lt_code:
            return u8"_arisenio_f64_lt";
         case wasm_ops::f64_le_code:
            return u8"_arisenio_f64_le";
         case wasm_ops::f64_gt_code:
            return u8"_arisenio_f64_gt";
         case wasm_ops::f64_ge_code:
            return u8"_arisenio_f64_ge";
         case wasm_ops::f64_promote_f32_code:
            return u8"_arisenio_f32_promote";
         case wasm_ops::f32_demote_f64_code:
            return u8"_arisenio_f64_demote";
         case wasm_ops::i32_trunc_u_f32_code:
            return u8"_arisenio_f32_trunc_i32u";
         case wasm_ops::i32_trunc_s_f32_code:
            return u8"_arisenio_f32_trunc_i32s";
         case wasm_ops::i32_trunc_u_f64_code:
            return u8"_arisenio_f64_trunc_i32u";
         case wasm_ops::i32_trunc_s_f64_code:
            return u8"_arisenio_f64_trunc_i32s";
         case wasm_ops::i64_trunc_u_f32_code:
            return u8"_arisenio_f32_trunc_i64u";
         case wasm_ops::i64_trunc_s_f32_code:
            return u8"_arisenio_f32_trunc_i64s";
         case wasm_ops::i64_trunc_u_f64_code:
            return u8"_arisenio_f64_trunc_i64u";
         case wasm_ops::i64_trunc_s_f64_code:
            return u8"_arisenio_f64_trunc_i64s";
         case wasm_ops::f32_convert_s_i32_code:
            return u8"_arisenio_i32_to_f32";
         case wasm_ops::f32_convert_u_i32_code:
            return u8"_arisenio_ui32_to_f32";
         case wasm_ops::f32_convert_s_i64_code:
            return u8"_arisenio_i64_f32";
         case wasm_ops::f32_convert_u_i64_code:
            return u8"_arisenio_ui64_to_f32";
         case wasm_ops::f64_convert_s_i32_code:
            return u8"_arisenio_i32_to_f64";
         case wasm_ops::f64_convert_u_i32_code:
            return u8"_arisenio_ui32_to_f64";
         case wasm_ops::f64_convert_s_i64_code:
            return u8"_arisenio_i64_to_f64";
         case wasm_ops::f64_convert_u_i64_code:
            return u8"_arisenio_ui64_to_f64";

         default:
            FC_THROW_EXCEPTION( arisenio::chain::wasm_execution_error, "Error, unknown opcode in injection ${op}", ("op", opcode));
      }
   }
   ...
   struct f32_promote_injector {
      ...
      static void accept( wasm_ops::instr* inst, wasm_ops::visitor_arg& arg ) {
         int32_t idx;
         injector_utils::add_import<ResultType::f64, ValueType::f32>( *(arg.module), u8"_arisenio_f32_promote", idx );
   ...
   struct f64_demote_injector {
      ...
      static void accept( wasm_ops::instr* inst, wasm_ops::visitor_arg& arg ) {
         int32_t idx;
         injector_utils::add_import<ResultType::f32, ValueType::f64>( *(arg.module), u8"_arisenio_f64_demote", idx );
         wasm_ops::op_types<>::call_t f32promote;
         f32promote.field = idx;
         f32promote.pack(arg.new_code);
      }
      ...
      public:
         ...
         void inject() {
            ...
            for ( auto& fd : _module->functions.defs ) {
               wasm_ops::ARISENIO_OperatorDecoderStream<pre_op_injectors> pre_decoder(fd.code);
            ...
            for ( auto& fd : _module->functions.defs ) {
               wasm_ops::ARISENIO_OperatorDecoderStream<post_op_injectors> post_decoder(fd.code);
...
}}} // namespace wasm_constraints, chain, arisenio
