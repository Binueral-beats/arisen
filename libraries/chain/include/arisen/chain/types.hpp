...
namespace arisenio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in ARISENIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the ARISENIO chain library.
    *
...
FC_REFLECT( arisenio::chain::void_t, )
