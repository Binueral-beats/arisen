...
#include <arisenio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::table_id_object, arisenio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::key_value_object, arisenio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(arisenio::chain::index64_object, arisenio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::index128_object, arisenio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::index256_object, arisenio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::index_double_object, arisenio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::index_long_double_object, arisenio::chain::index_long_double_index)

FC_REFLECT(arisenio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(arisenio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(arisenio::chain::index64_object)
REFLECT_SECONDARY(arisenio::chain::index128_object)
REFLECT_SECONDARY(arisenio::chain::index256_object)
REFLECT_SECONDARY(arisenio::chain::index_double_object)
REFLECT_SECONDARY(arisenio::chain::index_long_double_object)
