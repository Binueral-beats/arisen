...
FC_REFLECT( arisenio::chain::detail::block_header_state_common,
            (block_num)
...
FC_REFLECT( arisenio::chain::detail::schedule_info,
            (schedule_lib_num)
            (schedule_hash)
            (schedule)
)

FC_REFLECT_DERIVED(  arisenio::chain::block_header_state, (arisenio::chain::detail::block_header_state_common),
                     (id)
                     (header)
                     (pending_schedule)
