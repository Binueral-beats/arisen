...
FC_REFLECT(arisenio::chain::protocol_feature_subjective_restrictions,
               (earliest_allowed_activation_time)(preactivation_required)(enabled))

FC_REFLECT(arisenio::chain::protocol_feature_base,
               (protocol_feature_type)(dependencies)(description_digest)(subjective_restrictions))

FC_REFLECT_DERIVED(arisenio::chain::builtin_protocol_feature, (arisenio::chain::protocol_feature_base),
