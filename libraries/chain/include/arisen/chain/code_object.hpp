...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::code_object, arisenio::chain::code_index)

FC_REFLECT(arisenio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
