...
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::permission_object, arisenio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(arisenio::chain::permission_usage_object, arisenio::chain::permission_usage_index)

FC_REFLECT(arisenio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(arisenio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(arisenio::chain::permission_usage_object, (last_used))
