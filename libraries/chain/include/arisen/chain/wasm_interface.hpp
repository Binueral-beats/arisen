...
namespace arisenio { namespace chain {
      ...
      public:
         ...
         { try {
            ...
            if( whitelisted_intrinsics != nullptr ) {
               ...
               ARISEN_ASSERT( mod_name == "env", wasm_exception,
            ...
            ARISEN_THROW( wasm_exception, "${module}.${export} unresolveable",
                      ("module",mod_name)("export",export_name) );
            return false;
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against ARISENIO specific constraints
      ...
      private:
         ...
         friend class arisenio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( arisenio::chain::wasm_interface::vm_type, (wavm)(wabt) )
