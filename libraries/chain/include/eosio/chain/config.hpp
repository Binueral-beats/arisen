...
const static uint64_t eosio_auth_scope       = N(arisen.auth);
const static uint64_t eosio_all_scope        = N(arisen.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(arisen.any);
const static uint64_t eosio_code_name = N(arisen.code);
