...
function resources() {
    echo "${COLOR_CYAN}ARISENIO website:${COLOR_NC} https://rsn.io"
    echo "${COLOR_CYAN}ARISENIO Telegram channel:${COLOR_NC} https://t.me/ARISENProject"
    echo "${COLOR_CYAN}ARISENIO resources:${COLOR_NC} https://rsn.io/resources/"
