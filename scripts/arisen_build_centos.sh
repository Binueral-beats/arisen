...
( [[ $NAME == "CentOS Linux" ]] && [[ "$(echo ${VERSION} | sed 's/ .*//g')" < 7 ]] ) && echo " - You must be running Centos 7 or higher to install ARISENIO." && exit 1
...
ensure-yum-packages "${REPO_ROOT}/scripts/arisenio_build_centos7_deps"
