...
mkdir -p ${rsn_PREFIX}/licenses/arisenio
...
# install licenses
cp -R ${BUILD_DIR}/licenses/arisenio/* ${rsn_PREFIX}/licenses || exit 1

# install libraries
#cp -R ${BUILD_DIR}/lib/* ${rsn_PREFIX}/lib

# install cmake modules
#sed "s/_PREFIX_/\/${SPREFIX}/g" ${BUILD_DIR}/modules/arisenioTesterPackage.cmake &> ${rsn_PREFIX}/lib/cmake/${PROJECT}/arisenioTester.cmake
