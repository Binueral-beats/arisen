...
programs/arisenio-launcher/arisenio-launcher -p $pnodes -n $total_nodes --nogen -d $delay
...
b5idbios=`./programs/clrsn/clrsn -u http://localhost:12618 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clrsn/clrsn -u http://localhost:12618 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clrsn/clrsn -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
