...
try:
    ...
    if localTest and not dontLaunch:
        ...
        if cluster.launch(pnodes=prodCount, totalNodes=prodCount, prodCount=1, onlyBios=onlyBios,
                         ...
                         pfSetupPolicy=PFSetupPolicy.NONE, extraNodeosArgs=" --plugin arisenio::producer_api_plugin  --http-max-response-time-ms 990000 ") is False:
            cmdError("launcher")
    ...
    retMap = node0.publishContract("arisenio", contractDir, wasmFile, abiFile, True, shouldFail=True)
    ...
    time.sleep(0.6)
    retMap = node0.publishContract("arisenio", contractDir, wasmFile, abiFile, True)
