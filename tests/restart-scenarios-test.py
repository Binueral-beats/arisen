...
try:
    ...
    Print("Stand up ARISEN wallet awalletd")
    accountsCount=total_nodes
    walletName="MyWallet"
    Print("Creating wallet %s if one doesn't already exist." % walletName)
    wallet=walletMgr.create(walletName, [cluster.arisenioAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    arisenioAccount=cluster.arisenioAccount
    ...
    if not cluster.createAccounts(arisenioAccount):
