...
class Cluster(object):
    ...
    def __init__(self, walletd=False, localCluster=True, host="localhost", port=12618, walletHost="localhost", walletPort=9899, enableMongo=False
    ...
    def launch(self, pnodes=1, unstartedNodes=0, totalNodes=1, prodCount=1, topo="mesh", delay=1, onlyBios=False, dontBootstrap=False,
        ...
        if not self.walletd:
            nodrsnArgs += " --plugin arisen::wallet_api_plugin"
        if self.enableMongo:
            nodrsnArgs += " --plugin arisen::mongo_db_plugin --mongodb-wipe --delete-all-blocks --mongodb-uri %s" % self.mongoUri
        ...
        if PFSetupPolicy.hasPreactivateFeature(pfSetupPolicy):
            nodrsnArgs += " --plugin arisen::producer_api_plugin"
