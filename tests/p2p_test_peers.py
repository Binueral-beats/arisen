...
class P2PTestPeers:
    ...
    ports = [12618] # arisend listening port of each host
    ...
    #ports = [12618, 12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618,12618, 12618] # arisend listening port of each host
